package zhou.com.hyphenate.utils;
...
public class EaseCommonUtils {
    ...
    public static String getMessageDigest(EMMessage message, Context context) {
        ...
        switch (message.getType()) {
            ...
            case TXT: // 文本消息
                ...
                } else if (message.getBooleanAttribute(Contant.MESSAGE_ATTR_IS_VIDEO_CALL, false)) {
                    digest = getString(context, R.string.video_call) + txtBody.getMessage();
    ...
    public static EMConversation.EMConversationType getConversationType(int chatType) {
        if (chatType == Contant.CHATTYPE_SINGLE) {
            return EMConversation.EMConversationType.Chat;
        } else if (chatType == Contant.CHATTYPE_GROUP) {

...
import zhou.com.hyphenate.utils.EaseCommonUtils;
import zhou.com.loveme.MyApplication;
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(Contant.NEW_FRIENDS_USERNAME) || username.equals(Contant.GROUP_USERNAME)
                        || username.equals(Contant.CHAT_ROOM)|| username.equals(Contant.CHAT_ROBOT)) {

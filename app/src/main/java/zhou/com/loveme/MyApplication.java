...
import zhou.com.hyphenate.Contants.Contant;
import zhou.com.hyphenate.db.EaseUser;
import zhou.com.hyphenate.db.Myinfo;
import zhou.com.hyphenate.db.UserDao;

import static com.superrtc.call.NetworkMonitor.init;
...
public class MyApplication extends Application{
    ...
    public void setCurrentUserName(String username){
        ...
        Myinfo.getInstance(instance).setUserInfo(Contant.KEY_USERNAME,username);
    }

    public String getCurrentUserName(){
        if(TextUtils.isEmpty(username)){
            username = Myinfo.getInstance(instance).getUserInfo(Contant.KEY_USERNAME);
        }
        return username;
    }
